import { $r as saveOldStyle, A as isAxisOnBand, Ai as getViewOfComponentOrSeries, Ba as mathCeil, Bi as makeStyleMapper, C as requireAxisStatistics, Cr as decomposeTransform, Da as asc, Dn as createBoxLayoutReference, E as determineAxisType, Ea as addSafe, Ei as setDefaultStateProxy, Er as expandOrShrinkRect, F as shouldShowAllLabels, Ft as createSymbol$1, G as isIntervalOrLogScale, Ga as mathRound, Gr as subPixelOptimizeLine, H as getIntervalPrecision, Ha as mathMax$1, Hr as retrieveZInfo, I as updateIntervalOrLogScaleForNiceOrAligned, Ia as isPositionSizeOptionPercent, It as normalizeSymbolOffset, J as isTimeScale, K as isLogScale, Ka as nice, Kr as transformDirection, Kt as clear, L as AXIS_TYPES, La as isRadianAroundZero, Ln as decideCoordSysUsageKind, Lt as normalizeSymbolSize, M as isOnAxisZeroDiscouraged, Mi as ROAM_ACTION_TYPE_SUFFIX, Mn as getLayoutRect, N as retrieveAxisBreaksOption, Nn as mergeLayoutParam, Nr as groupTransition, O as getScaleValuePositionKind, Oa as getAcceptableTickPrecision, On as fetchLayoutMode, P as shouldAxisShow, Pa as isNullableNumberFinite, Pr as isBoundingRectAxisAligned, Pt as createOrUpdatePatternFromDecal, Qa as quantity, Qt as SeriesModel, R as LogScale, Ra as linearMap, Ri as getECData, Rn as injectCoordSysByOption, Rr as mergePath, S as registerMetricImpl, Sn as ComponentModel, T as createScaleByModel, Ta as MAX_SAFE_INTEGER, Tr as ensureCopyTransform, U as increaseInterval, Ua as mathMin$1, Ui as SINGLE_REFERRING, Ur as setTooltipConfig, V as ensureValidSplitNumber, Va as mathFloor, Vt as findEventDispatcher, W as intervalScaleEnsureValidExtent, Wa as mathPI, X as OrdinalMeta, Xa as parsePositionSizeOption, Xr as initProps, Y as getScaleExtentForMappingUnsafe, Ya as parsePercent, Yi as defaultEmphasis, Yr as getAnimationConfig, Zr as removeElement, Zt as ComponentView, _ as associateSeriesWithAxis, _i as enableComponentHighDownFeatures, _r as XY, a as parseGeoJSON, aa as makeInner, at as DataDiffer, b as eachSeriesDealForAxisStat, ba as error, bn as makeSeriesEncodeForNameBased, br as clipPointsByRect, ci as Polyline, dn as parseSanitizationFilter, ei as updateProps, er as getScaleBreakHelper, fi as Ellipse, fn as passesSanitizationFilter, fr as getLabelStatesModels, g as scaleRawExtentInfoEnableBoxCoordSysUsage, gi as SPECIAL_STATES, gr as WH, h as scaleRawExtentInfoCreate, hn as retrieveRawValue, i as createAxisLabelsComputingContext, ii as LinearGradient, io as __extends, ir as getUID, j as isNameLocationCenter, ji as COMPONENT_MAIN_TYPE_SERIES, jn as getLayoutParams, jr as getTransform$1, k as getTickValueOutermost, ki as toggleHoverEmphasis, la as normalizeToArray, li as Polygon, mi as createFromString, mr as setLabelStyle, n as calcBandWidth, ni as OrientedBoundingRect, nn as createTooltipMarkup, no as round, nt as SeriesData, o as GeoJSONRegion, oi as BezierCurve, or as Model, p as adoptScaleRawExtentInfoAndPrepare, pi as Circle, q as isOrdinalScale, qr as traverseElements, qt as createOrUpdate, r as AxisTickLabelComputingKind, ri as RadialGradient, rt as createDimNameMap, s as GeoSVGRegion, sa as makeQueryConditionKindA, si as Line$1, sr as LabelMarginType, t as Axis, to as remRadian, tr as hasBreaks, tt as prepareSeriesDataSchema, u as scaleCalcNice, ui as Ring, ur as createTextStyle, vr as applyTransform, vt as registerAction, w as AxisModelCommonMixin, wa as warn, wi as leaveEmphasis, wn as applyPreserveAspect, wr as ensureCopyRect, xa as log, xi as enterEmphasis, xn as tokens, z as IntervalScale, za as mathAbs, zr as payloadDisableAnimation } from "./Axis-DJ_gy-rZ.js";
import { $n as merge, An as each$1, B as TRANSFORMABLE_PROPS, Bt as copy$1, Cn as bind, D as Displayable, Dn as curry, En as createHashMap, F as Group, Fn as hasOwn, Ft as boundingRectCopy, Gn as isObject$1, Gt as mul, H as copyTransform, Ht as identity, In as indexOf, It as boundingRectCreate, Jt as translate, K as cloneValue, Kt as rotate, Mn as extend, Mt as boundingRectApplyTransform, Nn as filter, Nt as boundingRectCalculateTransform, On as defaults, Pn as find, Pt as boundingRectContain, Qn as map, Qt as stop, Rn as isArray, Rt as Point, Sn as assert, U as transformableCreate, Ut as invert, V as Transformable, Vn as isFunction, Vt as create, W as transformableGetLocalTransform, Wn as isNumber, Xn as keys, Xt as isMiddleOrRightButtonOnMouseUpDown, _ as TSpan, _t as parse, ar as retrieve, c as CompoundPath, dt as fastLerp, er as mergeAll, f as Rect, g as ZRImage, gt as modifyHSL, hn as normalize, ht as modifyAlpha, in as applyTransform$1, ir as reduce, jn as eqNaN, jt as BoundingRect, l as ZRText, mn as min, nn as Eventful, nr as noop, on as copy, or as retrieve2, pn as max, qn as isString, qt as scale, sr as retrieve3, tr as mixin, ur as trim, vn as set, vt as parseCssFloat, wn as clone, y as Path, yn as sub, yt as stringify, zn as isArrayLike } from "./graphic-BBQQ8MC6.js";
...
//#endregion
export { createSeriesDataSimply as $, updateRoamControllerSimply as A, viewCoordSysGetZoomOption as B, mapSeriesGroupHasOwnGeo as C, getDefaultInterpolatedLabel as Ct, createViewCoordSysSimply as D, createIsInSelfByPointerCheckerEl as E, shiftLayoutOnXY as Et, getOwnRoamViewCoordSys as F, install$3 as G, viewCoordSysSetViewRect as H, isViewCoordSys as I, AxisView as J, rectCoordAxisBuildSplitArea as K, viewCoordSysCopyBoundingRect as L, applyViewCoordSysTransToElement as M, calcCompensationScaleToPreserveNodeSize as N, isRoamPayloadHasZoom as O, clampByZoomLimit as P, axisModelCreator as Q, viewCoordSysCopyOverallMatrix as R, getMainMapSeries as S, Symbol as St, MapDraw as T, computeLabelGeometry as Tt, RoamController as U, viewCoordSysSetBoundingRect as V, install$2 as W, getAxisInfo as X, collect as Y, makeKey as Z, ECLinePath as _, warnDeprecated as _t, isTransitionAll as a, createMetricsNonOrdinalLinearPositiveMinGap as at, MapSeries as b, createFloat32Array as bt, makeLinearBrushOtherExtent as c, getCartesianAxisHashKey as ct, BrushController as d, AxisBuilder as dt, COORD_SYS_TYPE_CARTESIAN_2D as et, sliderMove as f, getAxisBreakHelper as ft, Line as g, isEC4CompatibleStyle as gt, LineDraw as h, convertToEC4StyleForCustomSerise as ht, applyUpdateTransition as i, createBandWidthBasedAxisContainShapeHandler as it, View as j, registerRoamActionSimply as k, makeRectIsTargetByCursor as l, isCartesian2DInjectedAsDataCoordSys as lt, injectThumbnailBridge as m, convertFromEC4CompatibleStyle as mt, stopPreviousKeyframeAnimationAndRestore as n, getStartValue as nt, updateLeaveTo as o, makeAxisStatKey as ot, getThumbnailBridge as p, Axis2D as pt, rectCoordAxisHandleRemove as q, applyLeaveTransition as r, requireAxisStatisticsForBaseBar as rt, install as s, makeAxisStatKey2 as st, applyKeyframeAnimation as t, SERIES_TYPE_PICTORIAL_BAR as tt, makeRectPanelClipPath as u, layout as ut, VisualMapping as v, isCoordinateSystemType as vt, mapSeriesNeedsDrawMap as w, getDefaultLabel as wt, buildAllMapSeriesGroups as x, SymbolDraw as xt, install$1 as y, isGeoLikeCoordSys as yt, viewCoordSysCopyTrans as z };
