...
//#endregion
export { getSRTTransformString as $, merge as $n, encodeHTML as $t, getElementSSRData as A, each as An, sort as At, TRANSFORMABLE_PROPS as B, isDom as Bn, copy as Bt, containStroke$4 as C, bind as Cn, cubicDerivativeAt as Ct, Displayable as D, curry as Dn, quadraticDerivativeAt as Dt, fromPoints as E, createHashMap as En, quadraticAt as Et, Group as F, hasOwn as Fn, boundingRectCopy as Ft, devicePixelRatio as G, isObject as Gn, mul as Gt, copyTransform as H, isGradientObject as Hn, identity as Ht, calculateTextPosition as I, indexOf as In, boundingRectCreate as It, adjustTextY$1 as J, isStringSafe as Jn, translate as Jt, cloneValue as K, isRegExp as Kn, rotate as Kt, getBoundingRect as L, inherits as Ln, createIntersectContext as Lt, registerPainter as M, extend as Mn, boundingRectApplyTransform as Mt, registerSSRDataGetter as N, filter as Nn, boundingRectCalculateTransform as Nt, truncateText as O, defaults as On, quadraticSubdivide as Ot, zrender_exports as P, find as Pn, boundingRectContain as Pt, getPathPrecision as Q, map as Qn, stop as Qt, getLineHeight as R, isArray as Rn, Point as Rt, containStroke$2 as S, assert as Sn, cubicAt as St, normalizeArcAngles as T, concatArray as Tn, cubicSubdivide as Tt, transformableCreate as U, isImagePatternObject as Un, invert as Ut, Transformable as V, isFunction as Vn, create as Vt, transformableGetLocalTransform as W, isNumber as Wn, matrix_exports as Wt, getIdURL as X, keys as Xn, isMiddleOrRightButtonOnMouseUpDown as Xt, encodeBase64 as Y, isTypedArray as Yn, addEventListener as Yt, getMatrixStr as Z, logError as Zn, normalizeEvent as Zt, TSpan as _, scaleAndAdd as _n, parse as _t, getLineDash as a, clone$1 as an, retrieve as ar, isLinearGradient as at, windingLine as b, vector_exports as bn, LRU as bt, CompoundPath as c, dist$1 as cn, setAsPrimitive as cr, normalizeColor as ct, parseFontSize as d, len as dn, util_exports as dr, fastLerp as dt, transformLocalCoord as en, mergeAll as er, getShadowKey as et, Rect as f, lerp$1 as fn, DEFAULT_FONT as fr, lerp as ft, ZRImage as g, scale$1 as gn, env as gr, modifyHSL as gt, subPixelOptimizeRect as h, normalize as hn, setPlatformAPI as hr, modifyAlpha as ht, createCanvasPattern as i, applyTransform as in, reduce as ir, isImagePattern as it, init as j, eqNaN as jn, BoundingRect as jt, createOrUpdateImage as k, disableUserSelect as kn, requestAnimationFrame as kt, ZRText as l, distSquare as ln, slice as lr, round4 as lt, subPixelOptimizeLine as m, min$1 as mn, platformApi as mr, liftColor as mt, brushLoopFinalize as n, Eventful as nn, noop as nr, isAroundZero as nt, getCanvasGradient as o, copy$1 as on, retrieve2 as or, isPattern as ot, subPixelOptimize as p, max$1 as pn, DEFAULT_FONT_FAMILY as pr, lift as pt, TEXT_ALIGN_TO_ANCHOR as q, isString as qn, scale as qt, brushSingle as r, add as rn, normalizeCssArray as rr, isGradient as rt, getSize as s, create$1 as sn, retrieve3 as sr, isRadialGradient as st, brush as t, transformLocalCoordClear as tn, mixin as tr, hasShadow as tt, hasSeparateFont as u, distance as un, trim as ur, color_exports as ut, DEFAULT_PATH_STYLE as v, set as vn, parseCssFloat as vt, PathProxy as w, clone$2 as wn, cubicRootAt as wt, normalizeRadian as x, __extends as xn, createCubicEasingFunc as xt, Path as y, sub as yn, stringify as yt, parsePercent as z, isArrayLike as zn, clone as zt };
